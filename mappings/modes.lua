...
-- {{{1 WINDOW MODE
M.window = key.mode("window_mode", function(theme)
  return {
...
-- {{{1 HELP MODE
M.help = key.mode("help_mode", function(theme)
  return {
...
-- {{{1 LANTERN MODE
M.lantern = key.mode("lantern_mode", function(theme)
  return {
